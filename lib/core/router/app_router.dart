...
abstract class AppRouter {
  //static GoRouter getRouter(bool isLoggedIn) => GoRouter(
    // initialLocation: isLoggedIn ? AppRouterPaths.kHomeView : AppRouterPaths.kLoginView,
    //
    // routes: [
    ...
    //   GoRoute(path: AppRouterPaths.kForgetPasswordView, builder: (context, state) => ForgetPasswordView()),
